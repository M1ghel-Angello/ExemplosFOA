...
//decimal salario = 50000.99m;
//idade *= 2; // idade = idade * 2
//Console.WriteLine($"A nova idade é {idade++}");//40
//Console.WriteLine($"A nova idade é {++idade}"); //42

//Altere o programa para que ele solicite ao usuário informar o seu salário e ao final informe o desconto de IRPF de acordo com o salário informado. Utilize a tabela oficial de descontos de IRPF do Brasil
...
if (salario <= 2428.8m)
    irpfDevido = 0;
else if (salario <= 2428.81m && salario <= 2826.65m)
